...
\section*{Oltre il Backend Tradizionale: Un'anteprima di Next.js}
Nelle prossime lezioni vedremo come l'evoluzione dei framework moderni stia portando verso una convergenza tra frontend e backend. Strumenti come \textbf{Next.js} permettono di costruire applicazioni "full-stack" dove la logica di presentazione e le API risiedono nello stesso progetto, eliminando complessità come la configurazione manuale del CORS e semplificando il deployment.

L'installazione è immediata tramite il comando:
\begin{lstlisting}[language=bash]
npx create-next-app@latest
\end{lstlisting}
Questo comando genera un'impalcatura pronta all'uso, includendo già strumenti come Tailwind CSS e il sistema di routing basato su file system, che approfondiremo nel dettaglio nella Lezione 5.
