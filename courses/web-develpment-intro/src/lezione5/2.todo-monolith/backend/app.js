...
app.use(cors()); // Abilitiamo CORS per permettere al frontend Next.js (porta 3000) di comunicare con questo server
...
app.get('/tasks', async (req, res) => {
    // Simula latenza di rete (1 secondo)
...
const PORT = 3001; // Cambiamo porta per non andare in conflitto con Next.js (3000)
