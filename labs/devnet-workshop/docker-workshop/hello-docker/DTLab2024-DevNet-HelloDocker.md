...
Visit the web [page](https://docs.docker.com/desktop/) and click on the
correct link based on your OS. Next, to the section matching your
environment.

<figure>
<img src="media/rId21.png" style="width:5.83333in;height:2.9668in"
alt="Docker desktop homepage" />
<figcaption aria-hidden="true"><p>Docker desktop
homepage</p></figcaption>
</figure>

<figure>
<img src="media/rId24.png" style="width:5.83333in;height:3.13835in"
alt="Docker desktop install" />
<figcaption aria-hidden="true"><p>Docker desktop
install</p></figcaption>
</figure>
...
<figure>
<img src="media/rId27.png" style="width:5.83333in;height:2.81624in"
alt="Windows docker desktop" />
<figcaption aria-hidden="true"><p>Windows docker
desktop</p></figcaption>
</figure>

#### Installing WSL

To install WSL, visit the
[docs](https://learn.microsoft.com/en-us/windows/wsl/install?source=docs).

Open a `Powershell (Administrator prompt)` and run the command
`wsl --install`. ![Windows docker
desktop](media/rId31.png){width="5.833333333333333in"
height="2.8982064741907263in"}
...
in Linux. You can install it from the [official
documentation](https://learn.microsoft.com/en-us/windows/terminal/install).

<figure>
<img src="media/rId31.png" style="width:5.83333in;height:2.89821in"
alt="Windows docker desktop" />
<figcaption aria-hidden="true"><p>Windows docker
desktop</p></figcaption>
</figure>
...
<figure>
<img src="media/rId40.png" style="width:5.83333in;height:2.8693in"
alt="Mac docker desktop" />
<figcaption aria-hidden="true"><p>Mac docker desktop</p></figcaption>
</figure>
...
<figure>
<img src="media/rId43.png" style="width:5.83333in;height:2.90316in"
alt="Mac docker desktop installation" />
<figcaption aria-hidden="true"><p>Mac docker desktop
installation</p></figcaption>
</figure>
...
<figure>
<img src="media/rId48.png" style="width:5.83333in;height:2.9735in"
alt="Linux docker engine install" />
<figcaption aria-hidden="true"><p>Linux docker engine
install</p></figcaption>
</figure>
...
If you are on Linux, you can run containers with `sudo`. If you want to
execute `docker` as a normal user you can put yourself in the
`docker group` running the command:
...
Now, you can execute any possible operating system with one command! For
example, you can create an Ubuntu instance.

    docker run ubuntu

*Why* does it exits immediately?

We need to tell the docker engine that we want to **interact** with the
container.
