...
\subsection{Playing with Docker}\label{playing-with-docker}
...
\emph{Why} does it exits immediately?

We need to tell the docker engine that we want to \textbf{interact} with
the container.
